...
class Post(models.Model):
    ...
    latitude = models.DecimalField(max_digits=11, decimal_places=8, default=-33.865143)
    longitude = models.DecimalField(max_digits=12, decimal_places=8, default=151.209900)
